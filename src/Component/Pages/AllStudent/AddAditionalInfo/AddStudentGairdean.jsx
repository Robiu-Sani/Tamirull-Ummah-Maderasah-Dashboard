    ...
    <div className="w-full mx-auto p-6 bg-white  rounded-lg">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-5">
          {/* Gairdean Name in Bangla */}
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              <FaUser className="inline mr-2" /> Gairdean`s Name (Bangla)
            </label>
            <input
              type="text"
              {...register("gairdeanNameBn", {
                required: "Gairdean's name in Bangla is required",
              })}
              className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-200"
              placeholder="অভিভাবকের নাম (বাংলা)"
            />
          ...
          {/* Gairdean Name in English */}
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              <FaUser className="inline mr-2" /> Gairdean`s Name (English)
            </label>
            <input
              type="text"
              {...register("gairdeanNameEn", {
                required: "Gairdean's name in English is required",
              })}
              className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-200"
              placeholder="Gairdean's Name (English)"
            />
